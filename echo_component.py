...
import sleekxmpp
from sleekxmpp.componentjabberd2 import ComponentJabberd2
...
class EchoComponent(ComponentJabberd2):
    ...
    def __init__(self, jid, secret, server, port):
        ComponentJabberd2.__init__(self, jid, secret, sasl_mech='DIGEST-MD5')
